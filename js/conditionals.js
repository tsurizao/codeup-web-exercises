(function() {
     ...
     */
        ...
        //     if(strColorName.toLowerCase() === 'red'){
        //         return "Red means STOP.";
        //     } else if(strColorName.toLowerCase() === 'yellow'){
        //         return "Bananas are yellow.";
        //     } else if(strColorName.toLowerCase() === 'blue'){
        //         return "The sky is blue.";
        //     } else {
        //         return "It looks like " + strColorName.toLowerCase() + " isn't a primary color.";
        //     }
        // }
...
// console.log(analyzeColor(randomColor));
    ...
    function analyzeColor(strColorName) {
        switch (strColorName.toLowerCase()) {
            ...
            default:
                return "It looks like " + strColorName.toLowerCase() + " isn't a primary color."
            // alert("It looks like " + strColorName.toLowerCase() + " isn't a primary color.");
            // break;
        }
    }
